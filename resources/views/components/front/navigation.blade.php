<nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
    <div class="container px-4 px-lg-5">
        <a class="navbar-brand d-flex align-items-center" href="{{ url('/') }}">
            <img src="{{ asset('storage/img/logo.png') }}" alt="TechInsight Logo" width="30" height="30" class="me-2">
            TechInsight
        </a>
            ...
            <ul class="navbar-nav ms-auto py-4 py-lg-0">
                ...
                @if (isset(Auth::user()->id))
                    ...
                    <li class="nav-item">
                        ...
                        href="#" onclick="event.preventDefault(); document.getElementById('form-logout').submit()">Logout</a></li>
                @else
